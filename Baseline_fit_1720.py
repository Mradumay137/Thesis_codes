...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar  1 14:38:01 2023
...
for m in range(0,6):
    ...
    for i in range(len(col1)):
        if col1[i]>1720 and col1[i]<1721:
        ...
        if col1[i]>1720 and col1[i]<1721:
            if col1[i]>1720 and col1[i]<1720.1:
                continue
    ...
    popt, pcov = curve_fit(func2, xvalue4, yvalue4)
        
    
    convol1=convolve(yvalueoriginal,Box1DKernel(1))
    convol1chopped=convol1[10:len(convol1)-10]
    
    xvalueoriginalchop=xvalueoriginal[10:len(xvalueoriginal)-10]
    yvalueoriginalchop=yvalueoriginal[10:len(yvalueoriginal)-10]
    ...
    for i in range(0,len(xvalueoriginal)):
        v=((1720.53-xvalueoriginal[i])*c/xvalueoriginal[i])
        velocity.append(v)
